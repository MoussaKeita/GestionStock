                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           ...
                           <f:form modelAttribute="client" action="${urlEnregistrer }" methode="post" enctype="multipart/form-data" role="form">
                             <f:hidden path="id"/>
                             <f:hidden path="photo"/>
                                 ...
                                 <label><fmt:message key="common.photo"/></label>
                                   <input type="file" name="file"/>
                                    ...
                                    <div class="panel-footer">
                                          ...
                                          <a href="<c:url value="/client/"/>" type="reset" class="btn btn-danger"><i class="fa fa-arrow-left">&nbsp;<fmt:message key="common.annuler"/></i></a>
                                    </div>
                           </f:form>
